...
namespace Kellerhoff.servicios
{
    public partial class generar_comprobantes_txt : System.Web.UI.Page
    {
        ...
        public string GrabarComprobantesTXT(string pRuta)
        {
            ...
            if (HttpContext.Current.Session["comprobantescompleto_Lista"] != null && HttpContext.Current.Session["comprobantescompleto_FechaDesde"] != null && HttpContext.Current.Session["comprobantescompleto_FechaHasta"] != null && HttpContext.Current.Session["clientesDefault_Cliente"] != null)
            {
                ...
                {
                    if (resultadoObjLista[i].Comprobante == "FAC")
                    {
                        ServiceReferenceDLL.cFactura objFactura = WebService.ObtenerFactura(resultadoObjLista[i].NumeroComprobante, ((cClientes)HttpContext.Current.Session["clientesDefault_Cliente"]).cli_login);
