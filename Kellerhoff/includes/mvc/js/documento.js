...
function CargarHtmlCabecera_Generico(objDocumento) {
    ...
    if (objTipoDocumento == 'FAC') {
        strHtmlDescarga += '<div class="load_gif" id="btn_to_hide-' + '2' + '-img"></div><a id="btn_to_hide-' + '2' + '"  class="btn_download float-right" href="' + httpRaiz + 'ctacte/generar_factura_csv?factura=' + objDocumento.Numero + '" data-toggle="tooltip" data-placement="bottom" title="Descargar en csv" data-original-title="Descargar en csv">CSV</a>';
