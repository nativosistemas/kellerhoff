    ...
    if (listSlider != null) {
        ...
        for (var i = 0; i < listSlider.length; i++) {
            ...
            if (listSlider[i].hsl_tipo == 1) {
                ...
                strHtml += '<a class="btn_slide pdfVerMas" onclick="onclickVerMasPdf(' + i + '); return false;" href="../../servicios/descargarArchivo.aspx?t=catalogo&n=' + listSlider[i].hsl_NombreRecursoDoc + '&inline=yes" target="_blank">ver más</a>';
